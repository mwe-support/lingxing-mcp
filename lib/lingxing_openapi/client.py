...
KNOWN_RATE_LIMIT_RULES: dict[str, RateLimitRule] = {
    ...
    "/pb/openapi/newad/spNegativeTargetsOrKeywords": RateLimitRule(1.0, 1, "openapi_docs"),
    "/pb/openapi/newad/hsaNegativeKeywords": RateLimitRule(1.0, 1, "openapi_docs"),
    "/pb/openapi/newad/hsaNegativeTargets": RateLimitRule(1.0, 1, "openapi_docs"),
    "/pb/openapi/newad/sdNegativeTargets": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/manage/putSpCampaign": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/manage/putSpAdGroup": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/manage/putSpKeyword": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/manage/putSpTarget": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/manage/putSpProductAds": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/spTarget/addKeywords": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/spTarget/addNegativeKeywords": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/spTarget/addNegativeTargets": RateLimitRule(1.0, 1, "openapi_docs"),
    "/basicOpen/adReport/spTarget/archiveNegatives": RateLimitRule(1.0, 1, "openapi_docs"),
    ...
    "/pb/openapi/newad/apiLogStandard": RateLimitRule(10.0, 10, "openapi_docs"),
