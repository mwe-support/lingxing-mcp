...
可选环境变量：
  ...
  LINGXING_MCP_HOST
  LINGXING_MCP_PORT
  LINGXING_MCP_ROLE_TOOLS
  LINGXING_MCP_AUDIT_ENABLED
...
ROLE_TOOLS_ESC="$(escape "${LINGXING_MCP_ROLE_TOOLS:-}")"
AUDIT_ENABLED_ESC="$(escape "${LINGXING_MCP_AUDIT_ENABLED:-1}")"
...
ssh "$REMOTE" \
  "sudo env \
    ...
    LINGXING_MCP_ROLE_TOOLS=${ROLE_TOOLS_ESC} \
    LINGXING_MCP_AUDIT_ENABLED=${AUDIT_ENABLED_ESC} \
